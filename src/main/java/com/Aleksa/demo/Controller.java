...
public class Controller {
	...
	public String bookingform(@Valid @ModelAttribute("bookingForm") bookingForm bookingform,
        ...
        String to = bookingform.getEmail(); // može i email korisnika
        String subject = "Nova rezervacija";
        String body = "Stigla je nova rezervacija od " + bookingform.getName() + ", Email " + bookingform.getEmail();
		...
		if(savebfs!=null) {
	        ...
	        emailService.sendReservationNotification(to, subject, body);
		}else {
			redirectAttributes.addFlashAttribute("message","Something went wrong!");
		}
